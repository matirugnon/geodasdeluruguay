            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a className="text-stone-600 hover:text-primary dark:text-stone-400 text-sm" href="#">Devoluciones</a></li>
                  <li><a className="text-stone-600 hover:text-primary dark:text-stone-400 text-sm" href="#">Contacto</a></li>
                </ul>
              </div>
              <div>
